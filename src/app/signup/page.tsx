...
import { ShieldPlus, Mail, Lock, User, Activity, FileText, Pill, ShieldCheck } from 'lucide-react';
      ...
      <div className="hidden w-1/2 flex-col justify-between bg-charcoal-blue-500 p-12 lg:flex">
        ...
        <div>
          ...
          <p className="text-charcoal-blue-800 text-lg max-w-md">
            Create an account to experience seamless multilingual consultations, smart workflows, and secure medical records.
          </p>
        </div>
      ...
      <div className="flex w-full flex-col justify-center px-8 lg:w-1/2 sm:px-16">
        <div className="mx-auto w-full max-w-md">
          ...
          <div className="mb-8 text-center lg:text-left">
            ...
            <h1 className="text-3xl font-bold text-dark-slate-grey-500 mb-2">Create an account</h1>
            <p className="text-charcoal-blue-500 font-medium">Please enter your details to sign up.</p>
          </div>
          ...
          <form onSubmit={handleSignup} className="space-y-5">
            <div>
              <label className="mb-1 block text-sm font-bold text-charcoal-blue-500">I am a...</label>
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                 {roles.map((r) => {
                   ...
                   return (
                     ...
                     >
                        <Icon className={`h-6 w-6 mb-2 ${isSelected ? 'text-deep-teal-500' : 'text-charcoal-blue-600'}`} />
            ...
            <div>
              <label className="mb-1 block text-sm font-bold text-charcoal-blue-500">Full Name</label>
            ...
            <div>
              <label className="mb-1 block text-sm font-bold text-charcoal-blue-500">Password</label>
              <div className="relative">
                <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-4">
          ...
          <p className="mt-8 text-center text-sm font-medium text-charcoal-blue-600">
            ...
            <Link href="/login" className="font-bold text-deep-teal-500 hover:text-dark-slate-grey-500 transition-colors">
              Log in
            </Link>
          </p>
        </div>
