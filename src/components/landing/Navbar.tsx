      ...
      <div className="container mx-auto px-4 md:px-8 flex h-[72px] items-center justify-between">
        ...
        <div className="flex items-center gap-10">
          <Link href="/" className="flex items-center gap-2">
            ...
            <span className="text-xl font-bold tracking-tight text-dark-slate-grey-500">
              MedFlow AI
            </span>
          </Link>
          <div className="hidden md:flex gap-6">
            <Link
              href="#solutions"
              className="text-sm font-medium text-charcoal-blue-600 hover:text-deep-teal-500 transition-colors"
            >
              Solutions
            </Link>
            <Link
