...
const steps = [
  {
    ...
    description: "Multilingual pre-screening and history gathering using AI avatars.",
    icon: User,
  },
  {
    number: "02",
    title: "Doctor Sync",
    description: "Live translation during the physical exam with automated notation.",
    icon: Activity,
  },
  {
    number: "03",
    title: "Lab Analysis",
    description: "Direct data integration from diagnostics for patient reporting.",
    icon: FileText,
  },
  {
    number: "04",
      ...
      <div className="container mx-auto px-4 md:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-8">
          <div className="max-w-xl">
            ...
            <p className="text-charcoal-blue-500 font-medium">
              See how MedFlow AI accelerates the entire diagnostic pipeline from initial intake to final prescription.
            </p>
          </div>
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4 mb-32">
          {steps.map((step, index) => (
            ...
            >
              ...
              <h3 className="mb-2 text-lg font-bold text-dark-slate-grey-500">{step.title}</h3>
        ...
        >
           <h2 className="mx-auto max-w-3xl text-4xl font-bold tracking-tight text-white md:text-5xl mb-12">
             Ready to transform your <br className="hidden sm:block" /> clinical communication?
           </h2>
